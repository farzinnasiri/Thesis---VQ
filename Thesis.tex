...
\puttitle{
	title={Beyond Reconstruction: Behavioral Probing of Discrete Image Tokenizers for Autoregressive Visual Generation}, % Title of the thesis
...
nearly all 16{,}384 nominal codebook entries. VQGAN uses about 972 active codes
...
tokenizer che produce tali token determina quindi sia la qualita' della
...
utilizza quasi tutti i 16{,}384 elementi nominali del codebook. VQGAN utilizza
...
risposta del decoder piu' concentrata, ma con effetti misurabili anche fuori
...
I risultati mostrano che la qualita' della ricostruzione non descrive da sola
...
\input{Chapters/ch09_limitations}
...
\begin{longtable}{p{0.20\textwidth}p{0.70\textwidth}}
    ...
    $\lambda$ & Encoder leakage ratio, $R_{\mathrm{out}}/(R_{\mathrm{in}}+\varepsilon)$. \\[2px]
    ...
    $\rho$ & Decoder leakage ratio, $\Delta_{\mathrm{out}}/(\Delta_{\mathrm{in}}+\varepsilon)$. \\[2px]
    $\varepsilon$ & Small positive constant used to stabilize ratio denominators. \\[2px]
\end{longtable}

...
\end{equation}
where $\varepsilon=10^{-8}$ prevents division by zero. The reported
$\lambda_{\mathrm{enc}}$ is the mean of per-image ratios, not the ratio of the
tabulated mean responses. All responses are fractions of
...
value, but the spatial pattern is shared. These small cross-checkpoint
differences are descriptive because the patch locations and noise draws were
not matched.

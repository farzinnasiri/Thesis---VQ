...
The experiment uses the ImageNet validation split and the shared preprocessing
and deterministic inference protocol described in
Chapter~\ref{ch:datasets_models_metrics}.

...
images to discrete token grids, but differ in architecture and codebook design.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{0.22\textwidth} >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X}
        ...
        Training objective & perceptual and adversarial reconstruction & reconstruction and codebook use \\
    \end{tabularx}
